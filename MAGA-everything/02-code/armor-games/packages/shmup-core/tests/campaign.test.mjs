...
const source = await build({ stdin: { contents: `export * from './sim'; export * from './packs';`, resolveDir: new URL('../src/', import.meta.url).pathname }, bundle: true, platform: 'node', format: 'esm', write: false });
